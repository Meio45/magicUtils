...
(function () {
    ...
    const runInContext = (function runInContext(context) {
        ...
        function LodashWrapper(value, chainAll) {
            this.__wrapped__ = value;  // 存储原始值
            this.__actions__ = []; // 存储执行的动作数组
            this.__chain__ = !!chainAll; // 是否启用链式调用
            this.__index__ = 0;
        ...
        */
        function mixin(object, source, options) {
            ...
            arrayEach(methodNames, function (methodName) {
                ...
                // 如果 object 是一个函数，则将该方法添加到 目标对象object 的原型对象中，使所有实例都能访问到
                if (isFunc) {
